 ...
 */
package de.hybris.wooliesegiftcard.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(WooliesgcFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(WooliesgcFulfilmentProcessConstants.PARENT_PROCESS);
