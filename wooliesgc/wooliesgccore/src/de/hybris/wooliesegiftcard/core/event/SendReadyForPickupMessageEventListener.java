...
public class SendReadyForPickupMessageEventListener extends AbstractAcceleratorSiteEventListener<SendReadyForPickupMessageEvent>
{
	...
	/**
	 * To process Send ready for pickup message
	 * 
	 * @param sendReadyForPickupMessageEvent
	 */
	@Override
	...
	/**
	 * To get site Channel details for Send ready for pickup message
	 * 
	 * @param event
	 *           the Send ready for pickup message
	 * @return siteChannel
	 */
	@Override
