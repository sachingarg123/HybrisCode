...
public class SendOrderPartiallyRefundedMessageEventListener
		extends AbstractAcceleratorSiteEventListener<SendOrderPartiallyRefundedMessageEvent>
{
	...
	/**
	 *  To process Send order partially refunded message
	 * @param sendOrderPartiallyRefundedMessageEvent
	 */
	@Override
	protected void onSiteEvent(final SendOrderPartiallyRefundedMessageEvent sendOrderPartiallyRefundedMessageEvent)
	{
		OrderModificationRecordEntryModel modificationRecordEntry = null;
		...
		modificationRecordEntry = sendOrderPartiallyRefundedMessageEvent.getProcess().getOrderModificationRecordEntry();
	...
	/**
	 * To get site Channel details for Send Order Partially Refunded Message
	 * 
	 * @param event
	 *           the Send Order Partially Refunded Message event
	 * @return siteChannel
	 */
	@Override
