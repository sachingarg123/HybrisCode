...
public class OrderCompletedEventListener extends AbstractAcceleratorSiteEventListener<OrderCompletedEvent>
{
	...
	/**
	 * To process the order completed event
	 * 
	...
	/**
	 * To get site Channel for order completed event event
	 *
	 * @param orderCompletedEvent
	 * @return
	 */
	@Override
	protected SiteChannel getSiteChannelForEvent(final OrderCompletedEvent orderCompletedEvent)
	{
		BaseSiteModel site = null;
		SiteChannel siteChannel = null;
		final OrderModel order = orderCompletedEvent.getProcess().getOrder();
		if (order != null)
		{
