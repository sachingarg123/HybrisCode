...
public class SubmitOrderEventListener extends AbstractAcceleratorSiteEventListener<SubmitOrderEvent>
{
	...
	/**
	 * To process submitted order event
	 * 
	 * @param submitOrderEvent
	 */
	@Override
	protected void onSiteEvent(final SubmitOrderEvent submitOrderEvent)
	{

		final OrderModel order = submitOrderEvent.getOrder();
		if (order != null)
		{
	...
	/**
	 * To get site Channel details for submitted order event
	 * 
	 * @param submitOrderEvent
	 * @return siteChannel
	 */
	@Override
	protected SiteChannel getSiteChannelForEvent(final SubmitOrderEvent submitOrderEvent)
	{
