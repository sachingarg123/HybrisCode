 ...
 */
package de.hybris.wooliesegiftcard.core.suggestion.dao.impl;
...
public class DefaultSimpleSuggestionDao extends AbstractItemDao implements SimpleSuggestionDao
{
	...
	/**
	 * To find related products that the user has bought by category.
	 *
	 * @param category
	...
	/**
	 * This method is used to find products related to products
	 * 
	 * @param products
	 * @param referenceTypes
	 * @param user
