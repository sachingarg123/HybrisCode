 ...
 */
package de.hybris.wooliesegiftcard.core.retention.impl;
...
public class DefaultCSTicketStagnationAction extends AbstractExtensibleRemoveCleanupAction
{
	...
	/**
	 * To clean up the closed tickets
	 *
	 * @param afterRetentionCleanupJobPerformable
	 * @param abstractRetentionRuleModel
	 * @param itemToCleanup
	 */
	@Override
	...
	/**
	 * To fetch localized closed ticket message
	 * 
	 * @return localizedClosedTicketMeesage
	 */
	private String fetchLocalizedClosedTicketMessage()
	{
	...
	/**
	 * To get ticket business service
	 * 
	...
	/**
	 * To set ticket business service
	 * 
