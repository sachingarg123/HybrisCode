 ...
 */
package de.hybris.wooliesegiftcard.cockpits.setup;
...
import de.hybris.wooliesegiftcard.cockpits.constants.WooliesgcCockpitsConstants;
 ...
 */
@SystemSetup(extension = WooliesgcCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(WooliesgcCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(WooliesgcCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						WooliesgcCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/wooliesgccockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
