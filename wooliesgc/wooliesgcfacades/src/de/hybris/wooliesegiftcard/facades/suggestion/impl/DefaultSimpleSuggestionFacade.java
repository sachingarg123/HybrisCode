 ...
 */
package de.hybris.wooliesegiftcard.facades.suggestion.impl;
...
import de.hybris.wooliesegiftcard.core.suggestion.SimpleSuggestionService;
import de.hybris.wooliesegiftcard.facades.suggestion.SimpleSuggestionFacade;
...
public class DefaultSimpleSuggestionFacade implements SimpleSuggestionFacade
{
	...
	/**
	 * This method is used to get references for purchased category
	 */
	@Override
	...
	/**
	 * This method is used to get references for products
	 */
	@Override
	...
	/**
	 * This method is used to get Suggestions For Products In Cart
	 */
	@Override
			...
			final boolean excludePurchased, final Integer limit)
	{
		...
		{
			final Set<ProductModel> products = new HashSet<ProductModel>();
			if (getCartService().getSessionCart().getEntries() != null && !getCartService().getSessionCart().getEntries().isEmpty())
			{
	...
	/**
	 * This method is used to get all base products
	 *
	 * @param productModel
	...
	/**
	 * To get simple suggestion service
	 *
	...
	/**
	 * To set simple suggestion service
	 *
