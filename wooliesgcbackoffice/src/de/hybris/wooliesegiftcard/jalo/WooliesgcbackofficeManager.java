 ...
 */
package de.hybris.wooliesegiftcard.jalo;
...
import de.hybris.wooliesegiftcard.constants.WooliesgcbackofficeConstants;
 ...
 */
public class WooliesgcbackofficeManager extends GeneratedWooliesgcbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(WooliesgcbackofficeManager.class.getName());
	 ...
	 */
	public static WooliesgcbackofficeManager getInstance()
	{
		return (WooliesgcbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(WooliesgcbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WooliesgcbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of WooliesgcbackofficeManager called.");
		}
	}
