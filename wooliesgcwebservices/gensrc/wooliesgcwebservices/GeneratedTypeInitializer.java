...
public class GeneratedTypeInitializer extends AbstractTypeInitializer
{
	...
	protected final void performCreateTypes( final ManagerEJB manager, Map params ) throws JaloBusinessException
	{
		...
		createItemType(
			...
			"CronJob",
			com.woolies.webservices.rest.jalo.expressupdate.cron.ProductExpressUpdateCleanerCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"CronJob",
			com.woolies.webservices.rest.jalo.expressupdate.cron.OrderStatusUpdateCleanerCronJob.class,
			null,
			false,
			null,
			false
		...
		createItemType(
			...
			"CronJob",
			com.woolies.webservices.rest.jalo.OldCartRemovalCronJob.class,
			null,
			false,
			null,
			false
