...
import com.woolies.webservices.rest.order.data.CardTypeDataList;
import com.woolies.webservices.rest.storesession.data.CurrencyDataList;
import com.woolies.webservices.rest.storesession.data.LanguageDataList;
import com.woolies.webservices.rest.swagger.ApiBaseSiteIdParam;
import com.woolies.webservices.rest.user.data.CountryDataList;
...
public class MiscsController extends BaseController
{
	...
	/**
	 * This method used to Get a list of available languages
	 *
	 * @param fields
	 * @return LanguageListWsDTO
	 */
	...
	/**
	 * This method used to Get a list of localized titles.
	 *
	 * @param fields
	 * @return TitleListWsDTO
	 */
	...
	/**
	 * This method used to get a list of supported payment card types
	 * 
	 * @param fields
	 * @return CardTypeListWsDTO
	 */
