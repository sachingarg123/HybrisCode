...
import com.woolies.webservices.rest.v2.helper.StoresHelper;
...
/**
 * This class is used store controller
 *
 *
 */
@Controller
...
public class StoresController extends BaseController
{
	...
	/**
	 * This method is used to get a header with the number of store locations
	 *
	 * @param query
	 * @param latitude
	 * @param longitude
	...
	/**
	 * This method is used to get location details
	 *
	 * @param storeId
	 * @param fields
	 * @return
