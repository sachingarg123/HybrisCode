 ...
 */
package com.woolies.webservices.rest.v2.config;
...
import com.woolies.webservices.rest.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "wooliesgcwebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "wooliesgcwebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "wooliesgcwebservices.oauth2.tokenUrl";

	private static final String DESC = "wooliesgcwebservices.v2.description";
	private static final String TITLE = "wooliesgcwebservices.v2.title";
	private static final String VERSION = "wooliesgcwebservices.v2.version";
	...
	/**
	 * This method is used to handle request mapping
	 * 
	 * @return
	 */
	@Override
	...
	/**
	 * This method confirgure all the messages
	 * 
	 * @param converters
	 */
	@Override
	...
	/**
	 * This method configure and resolve all the exceptions
	 * 
	...
	/**
	 * Gets Qauth for client credential flow
	 *
	 * @return
	 */
	...
	/**
	 * Gets Authorization scopes
	 *
	 * @param properyName
	 * @return AuthorizationScope list
	 */
