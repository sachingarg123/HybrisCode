 ...
 */
package com.woolies.webservices.rest.request.redirection;
 ...
 *    	<filter-class>com.woolies.webservices.rest.request.redirection.OAuthRedirectionFilter</filter-class>
 * 	</filter>
 *
 * 	<filter-mapping>
 * 		<filter-name>oauthRedirectionFilter</filter-name>
...
public class OAuthRedirectionFilter implements Filter
{
	...
	/**
	 * This method is used to redirect the url
	 * 
	 * @param request
	 * @param response
	 * @param chain
